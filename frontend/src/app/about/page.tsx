                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                      <p className="text-green-800 font-medium text-sm">
                        ✓ Landlord refunded ₹17,000 | ✓ Case settled successfully | ✓ Client satisfied and referring others
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">25+ Cities</span>
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">Court Expertise</span>
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded-full">Real Results</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center justify-center gap-4 bg-white/90 backdrop-blur-sm border border-gray-200/50 rounded-2xl px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2.5 rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Check Reviews
